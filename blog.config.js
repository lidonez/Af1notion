...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Af1', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '涤生，一个初学者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://af1.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '自我更新, 博客', // 网站关键词 英文逗号隔开
